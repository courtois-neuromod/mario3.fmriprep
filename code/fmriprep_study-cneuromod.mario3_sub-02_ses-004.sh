...
#SBATCH --job-name=fmriprep_study-cneuromod.mario3_sub-02_ses-004.job
#SBATCH --output=/lustre04/scratch/bpinsard/mario3.fmriprep/code/fmriprep_study-cneuromod.mario3_sub-02_ses-004.out
#SBATCH --error=/lustre04/scratch/bpinsard/mario3.fmriprep/code/fmriprep_study-cneuromod.mario3_sub-02_ses-004.err
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-cneuromod.mario3_sub-02_ses-004_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-cneuromod.mario3_sub-02_ses-004 ; fi 
